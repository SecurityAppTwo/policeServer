...
router.post("/addEvent", function(req, res) {
  ...
  switch (eventDetails.type) {
    ...
    VALUES (${eventDetails.injured}, ${eventDetails.driver}, ${eventDetails.injured_count}, ${eventDetails.date},
       ${eventDetails.reported_by}, ${eventDetails.report_date}, ${eventDetails.lon}, ${eventDetails.lat}, ${eventDetails.type});`;
      break;
    case "kidnapping_event":
      insertQuery = `
         ...
         VALUES (${eventDetails.kidnapper}, ${eventDetails.kidnapped}, ${eventDetails.last_location}, ${eventDetails.date},
          ${eventDetails.reported_by}, ${eventDetails.report_date}, ${eventDetails.lon}, ${eventDetails.lat}, ${eventDetails.type});`;
      break;
    case "shooting_event":
      insertQuery = `
      ...
      VALUES (${eventDetails.shooter}, ${eventDetails.weapon_type}, ${eventDetails.injured_count}, ${eventDetails.date},
        ${eventDetails.reported_by}, ${eventDetails.injured_type}, ${eventDetails.lon}, ${eventDetails.lat}, ${eventDetails.type});`;
      break;
    case "stabbing_event":
      insertQuery = `
      INSERT INTO public.stabbing_event(
      stabber, weapon_type, injured_count, date, reported_by, injured_type, lon, lat, type)
      VALUES (${eventDetails.stabber}, ${eventDetails.weapon_type}, ${eventDetails.injured_count}, ${eventDetails.date},
        ${eventDetails.reported_by}, ${eventDetails.injured_type}, ${eventDetails.lon}, ${eventDetails.lat}, ${eventDetails.type});`;
      break;
  }
  client.query(insertQuery).then(result => res.send(result.rows));
});
